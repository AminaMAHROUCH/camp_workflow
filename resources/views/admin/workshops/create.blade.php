    ...
    <div class="card-body">
        <form method="POST" action="{{ route("admin.workshops.store") }}" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                @endif
                <span class="help-block">{{ trans('cruds.workshop.fields.video_helper') }}</span>
            </div>
            <div class="form-group">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('quiz') ? 'is-invalid' : '' }}" type="text" name="quiz" id="quiz" value="{{ old('quiz', '') }}">
                @if($errors->has('quiz'))
                    <div class="invalid-feedback">
                        {{ $errors->first('quiz') }}
                    </div>
