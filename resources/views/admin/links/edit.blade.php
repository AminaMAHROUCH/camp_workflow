    ...
    <div class="card-body">
        <form method="POST" action="{{ route("admin.links.update", [$link->id]) }}" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('fosha') ? 'is-invalid' : '' }}" type="text" name="fosha" id="fosha" value="{{ old('fosha', $link->fosha) }}">
                @if($errors->has('fosha'))
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('request') ? 'is-invalid' : '' }}" type="text" name="request" id="request" value="{{ old('request', $link->request) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('evaluation') ? 'is-invalid' : '' }}" type="text" name="evaluation" id="evaluation" value="{{ old('evaluation', $link->evaluation) }}">
