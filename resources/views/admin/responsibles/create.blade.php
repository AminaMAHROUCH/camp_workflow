    ...
    <div class="card-body">
        <form method="POST" action="{{ route("admin.responsibles.store") }}" enctype="multipart/form-data">
            ...
            <div class="form-group">
             ...
             <div class="form-group">
                <label class="required" for="visisble_password">{{ trans('cruds.responsible.fields.visisble_password') }}</label>
                ...
                @endif
                <span class="help-block">{{ trans('cruds.responsible.fields.visisble_password_helper') }}</span>
             </div>
            <div class="form-group">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('bank_code') ? 'is-invalid' : '' }}" type="number" name="bank_code" id="bank_code" value="{{ old('bank_code', '') }}" step="1">
