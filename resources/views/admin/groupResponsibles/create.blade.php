...
<div class="card">
    <div class="card-header">
        {{ trans('global.create') }} {{ trans('cruds.groupResponsible.title_singular') }}
    </div>

    <div class="card-body">
        <form method="POST" action="{{ route("admin.group-responsibles.store") }}" enctype="multipart/form-data">
            @csrf
            ...
            <div class="form-group">
              ...
              <div class="form-group">
                <label class="required" for="visisble_password">{{ trans('cruds.groupResponsible.fields.visisble_password') }}</label>
                ...
                @endif
                <span class="help-block">{{ trans('cruds.groupResponsible.fields.visisble_password_helper') }}</span>
            </div> 
            <div class="form-group">
